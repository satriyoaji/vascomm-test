...
<body class="gray-bg">
    ...
    <div class="middle-box text-center animated fadeInDown">
        <h1>@yield('code')</h1>
        <h3 class="font-bold">@yield('message')</h3>

        <div class="error-desc">
            Sorry, but the page you are looking for cannot be loaded. Try checking the URL for error, then hit the refresh button on your browser or try found something else in our app.
