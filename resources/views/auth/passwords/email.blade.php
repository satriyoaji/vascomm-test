...
{{--                            </div>--}}
                            <form class="m-t" role="form" method="POST" action="{{ route('password.email') }}">
                                ...
                                @enderror
                                <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autofocus placeholder="masukkan email terdaftar">
                                @error('email')
                                ...
                                <small><i>*) Fitur reset password hanya bisa dilakukan oleh user yang memiliki akses ke email yang didaftarkan.</i></small>
                            </form>
                        </div>
                    </div>
                </div>
